...
/// Timeline tile shown at the beginning of a journey when the user's
/// origin is not at the first transit stop (first-mile connection).
class RoutingFirstConnectionTile extends StatelessWidget {
  final RoutingFirstConnectionInfo info;
  final bool showTopConnector;
  final bool showBottomConnector;

  const RoutingFirstConnectionTile({
    super.key,
    required this.info,
